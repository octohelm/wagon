...
replace (
	// follow from dagger
	github.com/moby/buildkit => github.com/moby/buildkit v0.12.1-0.20230919110756-bbe48e778f9d
...
require (
	...
	github.com/dagger/dagger v0.8.8
...
require github.com/vito/midterm v0.1.4 // indirect
